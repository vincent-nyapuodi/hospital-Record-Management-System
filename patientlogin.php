...
// it the selects the firstname and passwordfrom the registration table that was intially created
	$sql= "SELECT * FROM patient WHERE Reg_No='".$reg."' AND PASSWORD='".$encryptedPass."'";
	...
	if(password_verify($pass,$encryptedPass)){
		header("Location: patientrecords.php");// if correct opens a new home.php or any file you would want it to go to
	}
	else {
