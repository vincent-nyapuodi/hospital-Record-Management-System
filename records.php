...
<head>
    <link rel="stylesheet" type="text/css" href="../Healthcare/records.css">
            ...
            <div class="nav">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="../Healthcare/patientregister.html">Patient</a>
                        <a href="../Healthcare/doctorregister.html">Doctor</a>
                    </div>
                </div>
                <a class="btn" href="../Healthcare/records.php">Records</a>
...
<tr class="tab" style = "background-color: darkgrey;
        color: black;"><td colspan="11" align="center"> <font face="Arial">PATIENT RECORDS</font> </td> </tr>      
<tr class="tab"     style="background-color: darkgrey;color: black;"> 
